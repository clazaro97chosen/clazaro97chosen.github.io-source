...
RESUME_PDF_LINK = "downloads/misc/Resume_Cristian_Lazaro.docx"
...
# About Page
ABOUT_PAGE_TITLE = "About Cristian"
ABOUT_PAGE_DESCRIPTION = "Lifelong learner"
...
INDEX_PAGE_DESCRIPTION = (
    "A view of ideas from my laptop to your device | by Cristian Lazaro"
)
...
def process_techstacks(tech_dict, num_max_star):
    ...
    tech_stacks_list = [
        {key: {"filled_star": value, "empty_star": num_max_star - value}}
...
# git submodule add https://github.com/clazaro97chosen/clazaro97chosen.github.io.git output
